...
export const metadata = {
  site_name: "База отдыха Бор О Дача",
  generator: "Next.js", // Информация о генераторе, указывает на то, что сайт создан с помощью Next.js
  applicationName: "База отдыха Бор О Дача", // Название вашего отеля
  ...
  publisher: 'База отдыха Бор О Дача', // Имя издателя (вашего отеля)
  formatDetection: {
  ...
  assets: [
    "https://borodacha.ru/public", // Пример ссылки на хранение изображений
    "https://borodacha.ru/sitemap.xml", // Ссылка на файл sitemap
    "https://borodacha.ru/robots.txt", // Ссылка на файл robots.txt
  ],
...
export default function RootLayout({children}) {
  const jsonLd = {
    ...
    "@type": "Hotel",
    name: "База отдыха Бор О Дача",
    logo: "https://borodacha.ru/favicon180.png",
    contactPoint: {
      "@type": "ContactPoint",
