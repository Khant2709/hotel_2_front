...
import TerritoryContainer from "../particles/mainPage/territoryComponent/territoryContainer";
      ...
      <>
        ...
        <FullWidthWrapper>
          ...
          <CenteredWrapper>
            ...
            <TerritoryContainer territory={territory} imageMain={grouped.mainTerritory} images={grouped.territory}/>
            <ApartmentsByHotelComponent apartments={apartments}/>
            <DescriptionView description={description} phone={phone} image={grouped.aboutUs}/>
